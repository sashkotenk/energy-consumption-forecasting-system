...
from energy_forecast.database.analytics_repository import SqlAlchemyAnalyticsRepository
...
from energy_forecast.database.forecast_repository import SqlAlchemyForecastRepository
